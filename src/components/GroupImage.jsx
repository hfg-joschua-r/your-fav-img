...
export default function GroupImage(props) {
  ...
  const images = props.imgs.map((image, index) => {
    return (
      <div className="col-span-4 h-3/4" key={index}>
        ...
        <div className="text-ciWhite flex flex-col items-start px-2 pt-4 text-left">
  ...
  return (
    <div className="relative grid grid-row gap-8 grid-cols-12 h-screen items-center pt-10 pb-32 px-40 ">
      {images}
    </div>
  );
}
